...
public class Board_Mono_CLI extends Board_CLI {
    ...
    /**
     * Draws the board for the black piece player with the highlighted squares
     * that are valid moves for the selected piece.
     *
     * @param board - The board that the game is being played on.
     * @param pos   - The position array that holds all of the valid moves.
     */
    ...
    /**
     * Sets the highlighted fields of the position array to true when they are
     * valid moves
     *
