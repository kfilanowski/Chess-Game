...
/**
 * PieceIF that models a piece by extending BlackAndWhiteIF and using
 * ChessPieceType.
 *
 * @author Matt Lutz 40%
...
public interface PieceIF extends BlackAndWhiteIF {
     ...
     *
     * @param type - Sets the chess piece type.
     */
     ...
     * @return - An array that contains all the valid movement positions for
     *         this piece
     */
